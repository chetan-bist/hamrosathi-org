...
import WorkerProfile from "@/components/WorkerProfile"; // WorkerProfile import gareko

export default function DiscoverPage() {
  // Worker profile open bhako xa ki chaina track garne state
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
              ...
              <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow group cursor-pointer">
                <div className="flex gap-4">
                  <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 border-2 border-surface-container relative">
                    <Image alt="Rajesh Sharma" fill className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1HRON5ORKg9Y2CJT0x_p_jXsgUP3B1eX4ijRPEG68HFJ6_yQOcg2gW57fCHpGAqpusXiNghgfKYD4E3E5gAtO4mlGLginT_SklZ18NK1IWo-fVTL6aGnYbCkZLDxHDqz8HaHGsxiD19nOZ9X0XcHtA2Nak6kTXpzYD3nRx8GYl5o2fQzzYpMJ5qalq4NctvM_e-ulF_ITtBLITatlG2r8K_2P6jd6v3HElzP3_E8T9UWJfGMe5q7l" />
                  </div>
                  <div className="flex-1">
              ...
              <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow group cursor-pointer">
                <div className="flex gap-4">
                  <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 border-2 border-surface-container relative">
                    <Image alt="Sita Thapa" fill className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2NQJy8gQglzvBaqMRFniTvkDNdwopmmqV9G6pM6-21r4s5js4kOr28ap5Esn6IRbhgDdV7kUUYE9cEU3sJjRBuSDuY7SUqRqfRh4sWTu5FFE2EVBegrlEGD8455s2-rXIuoMDQN8P7yap_qbg8NemrLDSPAGluBi5uiu7HkK4ixKO_vIKARQ9mW9ZXiwyx7ETVK1agvqgYrdR3MyfV9Uqowe_KNMZ2uAHgwLpwNBqGZ5_zdgyZLvo" />
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
